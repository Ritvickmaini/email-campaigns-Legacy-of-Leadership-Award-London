            ...
            <tr>
              <td style="padding:30px">
                ...
                <p style="margin-top:25px;font-weight:bold">
                  ...
                  Mike<br/>
                  Show Director<br/>
                  <a href="mailto:mike@legacyofleadershipaward.com"
                     style="color:#D7262F">mike@legacyofleadershipaward.com</a><br/>
...
def send_email(sender_email, sender_password, row, subject, custom_html, cta_text, cta_url):
    try:
        server = smtplib.SMTP("mail.legacyofleadershipaward.com", 587)
        server.starttls()
...
sender_email = st.text_input("Sender Email", value="mike@legacyofleadershipaward.com")
